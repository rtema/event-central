...
export function useUserScopes(id: string | undefined) {
  return useSWR(id ? keys.userScopes(id) : null, () => usersApi.listScopes(id!));
}

export function useUserData(id: string | undefined) {
  return useSWR(id ? keys.userData(id) : null, () => usersApi.getData(id!), noRetryOn404);
}

export function useUserDataHistory(id: string | undefined) {
  return useSWR(
    id ? keys.userDataHistory(id) : null,
